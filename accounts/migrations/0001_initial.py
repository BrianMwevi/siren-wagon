    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('picture', models.ImageField(default='images/avatar_wqbvxp.svg', upload_to='images/')),
                ('medical_conditions', models.CharField(blank=True, max_length=200, null=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('emergency_contacts', models.ManyToManyField(blank=True, related_name='emergency_contact', to='accounts.emergencycontact')),
