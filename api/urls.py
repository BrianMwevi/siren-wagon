...
from api.views import AmbulanceViewset, DriverViewset, EmergencyContactViewset, HospitalViewset, SuccessfulResponse, TransactionsView, TripViewset, ReviewViewset, DoctorViewset, PackageViewset, PatientProfileView, UserRegisterView, LogoutView, ProcessPayments
...
urlpatterns = [
    ...
    path('payments/successfull/', SuccessfulResponse.as_view(), name='payments'),
